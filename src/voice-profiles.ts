...
const STYLE_KEYWORDS: Array<{ style: SpeechStyleId; keywords: string[] }> = [
  { style: "whisper", keywords: ["chuchot", "whisper", "secret", "confidentiel", "voix basse", "close-mic"] },
  { style: "urgent", keywords: ["urgent", "rapide", "vite", "press", "decisive", "crise", "alerte", "emergency"] },
  { style: "excited", keywords: ["drôle", "drole", "fun", "excited", "joueur", "enthousias", "taquin", "playful", "amusé", "amuse"] },
  { style: "mysterious", keywords: ["myst", "sombre", "enig", "suspen", "occult", "hint", "indice", "voilé", "voile"] },
  { style: "suspicious", keywords: ["suspect", "prud", "méfi", "mefi", "analyt", "deflect", "accus", "interrog", "sarcas", "ironie", "defens"] },
  { style: "tense", keywords: ["tendu", "tense", "stress", "menace", "pression", "danger", "tempete", "tempête", "infiltration"] },
  { style: "angry", keywords: ["colère", "colere", "angry", "furieux", "severe", "rival", "agacement", "froide"] },
  { style: "sad", keywords: ["triste", "sad", "melanc", "regret", "fragile", "endeuillé", "endeuille"] },
  { style: "calm", keywords: ["calme", "calm", "doux", "warm", "chaleureux", "posé", "pose", "maîtrisé", "maitrise", "retenu"] }
];
...
export function buildPersonaVoicePrompt(persona: PersonaSpec, theme: string, language: string | undefined, index = 0) {
  ...
  return [
    ...
    "Keep delivery compatible with short TTS playback; sample lines may use only approved GameForge emotion tags.",
